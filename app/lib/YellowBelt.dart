...
class YellowBeltPage extends StatefulWidget {
  final String? kataName;

  const YellowBeltPage({super.key, this.kataName});


  @override
  State<YellowBeltPage> createState() => _YellowBeltPageState();
}

class _YellowBeltPageState extends State<YellowBeltPage> {
  ...
  final List<Map<String, String>> lessons = [
    {
      'title': 'Lesson 1: Tenchi Happo 1-6 Traditional',
      'url': 'https://www.youtube.com/embed/fTqnJaLS_RY?start=0&end=399',
    },
    {
      'title': 'Lesson 2: Basic Combinations',
      'url': 'https://youtu.be/gIcix72-XC0?si=CIiVm_FZRwBW_1ap',
    },
    {
      'title': 'Lesson 3: Cat Stance',
      'url': 'https://youtu.be/kHIUkFahyKA?si=WR9cxKXQsp0oeb9j',
    },
    {
      'title': 'Lesson 4: Chi No Kata',
      'url': 'https://youtu.be/0R3zHQ59rd4?si=c_9weKGlXBSx_gqz',
    },
  ];
  ...
  Widget build(BuildContext context) {
    return YoutubePlayerBuilder(
      ...
      builder: (context, player) {
        return Scaffold(
          appBar: AppBar(
            title: const Text('Yellow Belt Curriculum'),
          ),
          body: Padding(
